      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="#">
          <img
            ...
            loading="lazy"
          />
          <span class="font1" style="color: #ffffff">ระบบจองตั๋วรถตู้</span>
        </a>
        <button
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto"> &nbsp;  &nbsp;  &nbsp;
            <li class="nav-item active" role="presentation">
              <router-link :to="{ name: 'front' }"><span style="color: #ffffff"><i class="fas fa-home"></i> Home</span></router-link>
            </li>  &nbsp;  &nbsp;  &nbsp;   
            <li class="nav-item" v-if="!isUserLoggedIn" role="presentation">
              <a href="#" v-on:click.prevent="showLogin = true"><span style="color: #ffffff"><i class="fas fa-key"></i> Login</span></a>
            </li> &nbsp;  &nbsp;  &nbsp;
            <li class="nav-item"  v-if="isUserLoggedIn" role="presentation">
              <router-link :to="{ name:'bookinglover' }"><span style="color: #ffffff" Y><i class="fas fa-tag"></i>Booking Ticket</span></router-link>
            </li> &nbsp;  &nbsp;  &nbsp;
            <li class="nav-item" v-if="!isUserLoggedIn" role="presentation">
              <a href="#" v-on:click.prevent="showRegister = true"><span style="color: #ffffff"><i class="fas fa-user-circle"></i> Register</span></a>
            </li>
            ...
            <li class="nav-item" v-if="isUserLoggedIn" role="presentation">
              <a href="#" v-on:click.prevent="logout"><span style="color: #ffffff"><i class="fas fa-power-off"></i> Logout</span>&nbsp;  &nbsp;  &nbsp;  &nbsp;</a>
